...
function LoginPage() {
  ...
  const [error, setError] = useState(() => {
    ...
    if (githubError || googleError) {
      ...
      return decodeURIComponent(githubError || googleError)
    }
    return ''
  })
        ...
        <div className="login-content">
          ...
          {mode === 'login' && (
            <>
              ...
              <button className="btn-google-auth" onClick={startGoogleAuth}>
              ...
              <p className="github-hint">Secure authentication via GitHub or Google</p>
            </>
          )}
